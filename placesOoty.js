...
const PlacesOoty = () => {
  return (
    ...
    <Row className='mt-5'>
        <Col lg={2}>
            <img src={require('../images/Home/ooty1 (1).jpeg')} alt='tourist places' height={'92%'} width={'100%'}/>
        </Col>
...
culture of Todas (a tribe of the Nilgirs).
        ...
        <Col lg={2}>
            <img src={require('../images/Home/ooty1 (2).jpeg')} alt='tourist places' height={'92%'} width={'100%'}/>
        </Col>
    </Row>

    <Row className='mt-5'>
        <Col lg={2}>
            <img src={require('../images/Home/ooty1 (3).jpeg')} alt='tourist places' height={'92%'} width={'100%'}/>
        </Col>
        <Col lg={10} className='p-2'>
...
enormous rock resembles a dolphin's nose and this is ane of the most visited tourist spots in The Nilgiris District of Tamil Nadu.
       ...
       <Col lg={2}>
           <img src={require('../images/Home/ooty1 (4).jpeg')} alt='tourist places' height={'92%'} width={'100%'}/>
       </Col>
   </Row>
   </Container>
  )
